...
from ivcr.datasets.builders.base_dataset_builder import BaseDatasetBuilder
from ivcr.datasets.datasets.llava_instruct_dataset import Instruct_Dataset
from ivcr.datasets.datasets.video_instruct_dataset import Video_Instruct_Dataset
...
class Video_Instruct_Builder(BaseDatasetBuilder):
    ...
    def build(self):
        ...
        datasets[split] = dataset_cls(
            ...
            vis_root=build_info.videos_dir,
            ann_root=build_info.anno_dir,
            vid_vname = build_info.vid_vname_dir,
            num_video_query_token=num_video_query_token,
            data_type=self.config.data_type,
            model_type=model_type,
            num_frm=num_frm,
...
@registry.register_builder("ivcr_instruct")
class IVCRInstruct_Builder(Video_Instruct_Builder):
    train_dataset_cls = Video_Instruct_Dataset

    # DATASET_CONFIG_DICT = {
    #     "default": "configs/datasets/instruct/ivcr_instruct.yaml",
    # }
